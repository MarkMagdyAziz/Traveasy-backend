...
const GetAllFlight = async (req, res) => {
    try {
      const FlightList =   await FlightDB.find({})
        .populate("Tourist").populate("Airline")
        .exec(); res.send(FlightList)              
    } catch (error) {
...
const GetFlightByID = async (req, res)=> {    
   ...
   try {
    ...
    .populate("Tourist").populate("Airline").exec()
...
module.exports = { CreateFlight , GetAllFlight , GetFlightByID ,DeleteFlight , updateFlight , SerachFlight};
